...
export default function Sidebar() {
  ...
  const handleClearChats = async () => {
    const confirmed = window.confirm("Are you sure you want to clear all chats? This action cannot be undone.");
  ...
  if (!confirmed) {
    ...
    try {
      ...
      setFeedbacks([]); // Clear feedbacks from UI instantly
  ...
  return (
    <div className="relative h-screen">
      {/* Toggle button (hamburger icon) when sidebar is closed */}
      {!isSidebarOpen && (
        <button
